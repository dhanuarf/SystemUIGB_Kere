...
public class CircleImageView extends ImageView
{
	...
	int warnaBorder= Color.WHITE;

	private int mCornerRadius = DEFAULT_RADIUS;
	private int mBorderWidth = DEFAULT_BORDER_WIDTH;
	private ColorStateList mBorderColor =
	ColorStateList.valueOf(warnaBorder);
	...
	public CircleImageView(Context c)
	{
		super(c);
	}

	public CircleImageView(Context c, AttributeSet attrs)
	{
		this(c, attrs, 0);
	}
	public CircleImageView(Context c, AttributeSet attrs, int defStyle)
	{
		super(c, attrs, defStyle);
		setScaleType(ScaleType.CENTER_CROP);
		mCornerRadius = DEFAULT_RADIUS;
		mBorderWidth = DEFAULT_BORDER_WIDTH;
		mBorderColor = ColorStateList.valueOf(warnaBorder);
	...
	public void setBorderColors(ColorStateList colors)
	{
		...
		mBorderColor =
			(colors != null) ? colors : ColorStateList.valueOf(warnaBorder);
		updateDrawableAttrs();
		updateBackgroundDrawableAttrs();
		if (mBorderWidth > 0)
		{
