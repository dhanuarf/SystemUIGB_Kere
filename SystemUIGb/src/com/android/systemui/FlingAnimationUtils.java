...
import support.animator.animation.Animator;
import support.animator.animation.ValueAnimator;
import android.content.Context;
import support.animator.view.ViewPropertyAnimator;
...
public class FlingAnimationUtils {
    ...
    public FlingAnimationUtils(Context ctx, float maxLengthSeconds) {
        ...
        mFastOutSlowIn = new PathInterpolator(0.4f, 0, 0.2f, 1f);
        mFastOutLinearIn = new PathInterpolator(0.4f, 0, 1f, 1f);
    ...
    public void apply(Animator animator, float currValue, float endValue, float velocity,
		...
		//android.util.Log.d("flingAnim", "properties: "+ properties + "dur: "+ properties.duration+" interpolator: "+properties.interpolator);
    ...
    public void apply(ViewPropertyAnimator animator, float currValue, float endValue,
        ...
        animator.setDuration(properties.duration);
        animator.setInterpolator(properties.interpolator);
		//android.util.Log.d("flingAnim", "properties: "+ properties);
    }
