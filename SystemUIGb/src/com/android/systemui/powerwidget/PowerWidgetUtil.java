...
public class PowerWidgetUtil {
    ...
    static {
        ...
        BUTTONS.put(BUTTON_NIGHTMODE, new PowerWidgetUtil.ButtonInfo(
						BUTTON_NIGHTMODE, R.string.title_toggle_night_mode, "com.android.systemui:drawable/stat_night_mode_on"));
        BUTTONS.put(BUTTON_DSB, new PowerWidgetUtil.ButtonInfo(
						BUTTON_DSB, R.string.title_toggle_dsb, "com.android.systemui:drawable/stat_dsb_on"));
    ...
    public static String getCurrentButtons(Context context) {
        String buttons = Settings.System.getString(context.getContentResolver(), Nusettings.WIDGET_BUTTONS);
        if (buttons == null) {
 ...
 //           }
  ...
  //          if (context.getResources().getBoolean(R.bool.has_led_flash)) {
               if(false) buttons += BUTTON_DELIMITER + BUTTON_FLASHLIGHT;
    ...
    public static void saveCurrentButtons(Context context, String buttons) {
        Settings.System.putString(context.getContentResolver(),
                Nusettings.WIDGET_BUTTONS, buttons);
    }
