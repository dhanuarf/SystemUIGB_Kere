...
public class TouchInterceptor extends ListView {
    ...
    public TouchInterceptor(Context context, AttributeSet attrs) {
        ...
        mItemHeightNormal =  res.getDimensionPixelSize(R.dimen.dragitem_normal_height);
        mItemHeightHalf = mItemHeightNormal / 2;
        mItemHeightExpanded = res.getDimensionPixelSize(R.dimen.dragitem_expanded_height);
    }
    ...
    private void startDragging(Bitmap bm, int y) {
        ...
        int backGroundColor = 0xaaff0000;// context.getResources().getColor(R.color.dragndrop_background);
